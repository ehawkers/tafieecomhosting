...
const UpdateProduct = () => {
  ...
  useEffect(() => {
    axios
      .get("https://twicksback.onrender.com/api/getProduct/" + id)
      .then((res) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    const imageUrl = await axios.post(
      "https://twicksback.onrender.com/api/uploadImage",
      formData
    );

    if (imageUrl.data.success) {
      axios
        .patch("https://twicksback.onrender.com/api/updateProduct/" + id, {
