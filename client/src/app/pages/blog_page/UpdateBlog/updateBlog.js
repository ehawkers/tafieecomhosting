...
const UpdateBlog = () => {
  ...
  const getOneBlog = async () => {
    try {
      const { data } = await axios.get("https://twicksback.onrender.com/api/blog/" + id);
      console.log(data);
      setInputHandler({
  ...
  useEffect(() => {
    axios
      .put("https://twicksback.onrender.com/api/updateBlog/" + id)
      .then((res) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    var imageUrl = await axios.post(
      "https://twicksback.onrender.com/api/uploadBlogImage",
      formData
    );
