        ...
        try {
            ...
            // } else {
                const response = await axios.post(
                    "https://twicksback.onrender.com/api/ship/calcShipment",
                    {
    ...
    try {
      if (shipCharge === undefined) {
        ...
        const { data } = await axios.post(
          "https://twicksback.onrender.com/api/putUserAddress",
          {
            userId: user._id,
        ...
        if (data.success) {
          ...
          const { data } = await axios.post(
            "https://twicksback.onrender.com/api/pay/phonePePayment",
            {
